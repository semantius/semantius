...
| Automated Enrollment Rules | `automated_enrollment_rules` | Rule engine entry that auto-enrols learners into courses or paths based on audience membership and lifecycle events. |
