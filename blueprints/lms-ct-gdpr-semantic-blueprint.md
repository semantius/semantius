...
| --- | --- | --- |
| Data Deletion Requests | `data_deletion_requests` | GDPR Article 17 right-to-erasure request: scope, anonymisation policy, regulator deadline, fulfilment status. |
...
| Subject Access Requests | `subject_access_requests` | GDPR Article 15 subject-access-request ticket: requester, scope, fulfilment status, regulator deadline. |
