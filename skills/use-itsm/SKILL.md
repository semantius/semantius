...
| Domain not deployed (empty slice) | Stop; offer the blueprint deploy. | *"The IT Service Management domain isn't deployed on your platform yet. It can be added from the catalog. Want me to walk you through deploying it?"* |
