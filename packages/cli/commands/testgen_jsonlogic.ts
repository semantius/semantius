 ...
 * Generates 0100_test_jsonlogic.sql from 0100_test_jsonlogic.json
 *
 * JSON format:
...
const JSON_INPUT_NAME = "0100_test_jsonlogic.json";
const SQL_OUTPUT_NAME = "0100_test_jsonlogic.sql";
...
export async function testgenJsonlogicCommand(): Promise<void> {
  ...
  lines.push(
    "-- DO NOT EDIT - modify 0100_test_jsonlogic.json and run deno task testgen_jsonlogic",
  );
  lines.push("BEGIN;");
  lines.push("");
