...
S4, S13, S15, P1, P3, P6, P12, B1 to B10, B12 to B16, B19, R1 to R5, T1) mean fixed or
...
| Q5 | Low | migration | `rename_dd_table`, pgmq `drop_queue`, `queue_event_after_insert`, and others | 11 unused or never-read variables. Was 12; `has_permission`'s `v_external_id` became live on 2026-09-05 with P3. Not re-linted since. | Remove. | The 11 warnings are gone. |
