...
S6, S9, S10, S11, S13, S15, P1, P2, P3, P4, P6, P12, P13, B1 to B10, B12 to B16, B19, B20, B21,
...
- **S7 and S8 are owned by `plans/security-grants-and-guards.md`** since
  2026-09-05. Reviewed twice by an independent agent the same day, and every
  decision in it is answered by the owner. **Q7 was accepted and closed** the
  same day: the vendored pgmq functions are unreachable from PostgREST and
  expose metadata only over a DB-only path (`plans/ext-solved-items.md`).
