-- pg_semantic_platform extension upgrade: 0.1.1 -> 0.1.2
-- Generated by `deno task extension` from migrations added since 0.1.1.
...
-- No new migrations since 0.1.1; version bump only.
