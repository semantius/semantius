...
$pgsem__core_0030_rbac_functions$;
    ...
    END;
    INSERT INTO public._versions (name, checksum)
      VALUES ('_core.0030_rbac_functions', '4219bae3a99ddf22f792dc99d4f239791d29ac6e66590fecbe5e8bdef33df7c1');
    v_applied := v_applied + 1;
  ELSE
    v_skipped := v_skipped + 1;
  END IF;
...
$pgsem__core_0110_apikeys$;
    ...
    END;
    INSERT INTO public._versions (name, checksum)
      VALUES ('_core.0110_apikeys', 'fd2b3dd0d9a921628c4d59ffcb65274e0f43f556e4b15094d77e7b77bfb94ea0');
    v_applied := v_applied + 1;
  ELSE
    v_skipped := v_skipped + 1;
  END IF;
...
$pgsem__core_0250_webhook_receiver$;
    ...
    END;
    INSERT INTO public._versions (name, checksum)
      VALUES ('_core.0250_webhook_receiver', 'dbe8a9cd97314f72182f4564e29a81eabdfbc1e52dbeddf49ee4e3a8dad1915f');
    v_applied := v_applied + 1;
  ELSE
    v_skipped := v_skipped + 1;
  END IF;
...
$pgsem__core_0260_dashboard$;
    ...
    END;
    INSERT INTO public._versions (name, checksum)
      VALUES ('_core.0260_dashboard', '73561870f7361b9a2d8e915dce31be530f66a3d8f3758b349f247d9d3702a613');
    v_applied := v_applied + 1;
  ELSE
    v_skipped := v_skipped + 1;
  END IF;
