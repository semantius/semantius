...
REM Ports are the .env defaults (7070 front door, 3000 API); edit here if you
...
echo == 1. Front door (caddy) @ http://localhost:7070 ==
...
curl -s http://localhost:7070/config.js | findstr /C:"VITE_CONTROL_PLANE_URL"
...
echo == 2. OpenAPI spec (no token) @ http://localhost:3000/ ==
