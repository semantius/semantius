...
INSERT INTO modules (id, module_name, module_slug, description, view_permission, home_page) VALUES
    (1001, 'CRM',       'crm',       'Customer Relationship Management', 'sales:read', '/crm/customers_test'),
    (1002, 'HR',        'hr',        'Human Resources',                  'user:read',  DEFAULT),
    (1003, 'Inventory', 'inventory', 'Inventory Management',             DEFAULT,      '/inventory/products_test')
...
INSERT INTO products_test (product_name, sku, description, price, quantity_in_stock, is_discontinued)
VALUES
    ('Widget Pro', 'WGT-001', 'Professional grade widget', 29.99, 150, FALSE),
    ('Gadget Plus', 'GAD-002', 'Advanced gadget with premium features', 49.99, 75, FALSE),
    ('Tool Basic', 'TL-003', 'Basic tool for everyday use', 19.99, 0, TRUE);
