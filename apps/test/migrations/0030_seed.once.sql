...
-- assigned by auto_assign_user_role_trigger (_core 0100_rbac_rls.sql); user3 is the administrator.
--
...
-- an unexplained failure three files away, and 0210_test_first_user_get_userinfo
