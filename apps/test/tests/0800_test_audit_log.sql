-- The audit log: DML and DDL audit, and the TRUNCATE path.
--
...
-- =====================================================
-- PART 2: TRUNCATE audit path
-- =====================================================
-- audit.truncate_trigger() (0200_audit_log.sql) was never executed by the
-- suite: part 1 covers INSERT/UPDATE/DELETE and DDL audit only. TRUNCATE needs
...
-- rows are created as admin (user3) exactly like part 1 does.
