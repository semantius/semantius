-- pgmq itself, below the queues entity: the install, and the vendored
-- functions the queue wiring does not call.
--
...
-- (0840_test_queue.sql); this part asserts the install itself so a
-- broken/missing 0310_pgmq.once.sql surfaces here, before 0840_test_queue.sql,
...
-- =====================================================
-- PART 2: pgmq operations
-- =====================================================
-- Part 1 only smoke-tests pgmq.create/send/read. The first coverage run
...
-- part exercises the message lifecycle (send_batch, read_with_poll, set_vt,
...
--
-- Runs as the owner like part 1: the pgmq schema is not a PostgREST surface
