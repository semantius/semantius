...
SELECT is(
    (SELECT plural FROM entities WHERE table_name = 'customers'),
    'customers',
...
SELECT is(
    (SELECT plural FROM entities WHERE table_name = 'employees'),
    'employees',
...
SELECT is(
    (SELECT plural FROM entities WHERE table_name = 'products'),
    'products',
