...
SELECT has_column('public', 'entities', 'catalog_owner_module',   'entities.catalog_owner_module exists');
...
SELECT is((SELECT ctype FROM fields WHERE table_name='entities' AND field_name='catalog_owner_module'),   'core', 'catalog_owner_module registered ctype=core');
...
SELECT is((SELECT catalog_owner_module   FROM entities WHERE table_name='prov_e'), '',             'fresh entity: catalog_owner_module empty');
