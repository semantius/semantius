-- Modules: visibility by view_permission, and module_slug derivation and
-- validation.
--
...
--   1. Module visibility
--   2. module_slug derivation and validation
BEGIN;

SELECT plan(33);

-- =====================================================
-- PART 1: Module visibility
-- =====================================================
...
-- =====================================================
-- PART 2: module_slug derivation and validation
-- =====================================================
