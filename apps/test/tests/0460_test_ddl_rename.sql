-- DDL rename support: renaming tables and fields, and renaming an entity's
-- label_column.
--
...
--   1. Table and field rename
--   2. label_column rename
BEGIN;

SELECT plan(37);

-- =====================================================
-- PART 1: Table and field rename
-- =====================================================
