...
VALUES 
    ('webhook_receiver_logs', 'webhook_receiver_id', 'Webhook Receiver', 'reference', FALSE, FALSE, 10, 'default', 's', 'Reference to webhook receiver configuration', NULL, NULL, NULL, 'webhook_receivers', 'clear'),
