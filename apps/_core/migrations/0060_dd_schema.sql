...
VALUES 
    ...
    ('tables', 'icon_url', 'Icon URL', 'Optional URL or path to icon for this table', 'uri', FALSE, TRUE, 50, NULL, TRUE),
...
VALUES 
    ...
    ('modules', 'logo_url', 'Logo URL', 'URL or base64 data URI for module logo', 'uri', FALSE, TRUE, 35, NULL, TRUE),
