...
The `/semantic-model-analyst` [agent skill](/docs/agent-skills-overview) builds a [semantic model](/docs/models-overview) with you, the way a senior analyst would: interview, propose, confirm, write. The output is a single self-contained markdown file describing entities, fields, and relationships, ready for the [Deploy](/docs/models-deploy) step.
...
Install the Semantius CLI and the [agent skills](/docs/agent-skills-overview) bundle to add this skill to your agent.
