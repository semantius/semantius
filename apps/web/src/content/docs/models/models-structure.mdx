...
This page is a technical reference for what a `*-semantic-model.md` file actually contains. It is the companion to the [Models Overview](/docs/models-overview): the overview tells you what a model is for, this page tells you what is in the file. If you are about to read, write, or review one by hand, start here.
