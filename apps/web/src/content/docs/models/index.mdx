...
A **semantic model** is the heart of every Semantius platform. It describes your domain as data: the entities you care about, the attributes that define them, the relationships between them, and the rules that govern who can access what. Models are built and evolved through [agent skills](/docs/agent-skills-overview) and consumed by AI clients through [MCP connectors](/docs/mcp-connectors-overview).
