...
- **[use-semantius skill](/docs/cli-skill)**: install a ready-made skill that teaches a coding agent to drive the CLI productively, including the schema-first creation order and read-before-write rules.
- **[Agent Skills Overview](/docs/agent-skills-overview)**: see how the higher-level skills (Business Analyst, Schema Editor, RBAC Configurator, Deployer, Optimizer) sit on top of this same CLI.
