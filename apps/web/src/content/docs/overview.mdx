...
At the center of Semantius is the **[semantic model](/docs/models-overview)**. A semantic model captures:
...
Semantius exposes its model through **[MCP servers](/docs/mcp-connectors-overview)**, so you can connect AI chats like **ChatGPT** and **Claude** directly to your data.
...
The MCP layer is the bridge between conversational AI and your operational data, with the semantic model providing the vocabulary. See [MCP Connectors](/docs/mcp-connectors-overview) for the full list of servers and clients, and [Installation](/docs/mcp-connectors-installation) for setup.

## Agentic Skills

Semantius is **agentic** by design. It ships with **[skills](/docs/agent-skills-overview)** that agents can use to build, test, and deploy models end to end:
