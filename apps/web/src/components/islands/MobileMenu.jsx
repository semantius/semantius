...
export default function MobileMenu({ 
  ...
  labels = {
    ...
    getStarted: 'Sign up',
    signIn: 'Sign in',
    signInHref: ACTION_LINKS.signIn?.href || 'https://app.semantius.com/'
  }
}) {
            ...
            >
              ...
              <div className="pt-6 md:pt-8 border-t border-foreground/10 flex flex-col gap-4 mt-auto">
                 <a 
                  ...
                  <a 
                    href={labels.signInHref || ACTION_LINKS.signIn?.href}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full py-3 px-4 border border-foreground/20 text-foreground text-center font-semibold rounded-lg hover:bg-foreground/5 transition-all"
                  >
