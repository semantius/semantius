...
<p align="center">
  <a href="https://deploy.workers.cloudflare.com/?url=https://github.com/GladTek/Semantius">
    <img src="https://deploy.workers.cloudflare.com/button" alt="Deploy to Cloudflare Workers" />
  </a>

  <a href="https://app.netlify.com/start/deploy?repository=https://github.com/GladTek/Semantius">
    <img src="https://www.netlify.com/img/deploy/button.svg" alt="Deploy to Netlify" />
  </a>

  <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FGladTek%2FSemantius">
...
| Platform   | URL                                      |
| :--------- | :--------------------------------------- |
| **Cloudflare** | [https://semantius.gladtek.com/](https://semantius.gladtek.com/) |
| **Netlify**    | [https://astro-semantius.netlify.app/](https://astro-semantius.netlify.app/) |
| **Vercel**     | [https://astro-semantius.vercel.app/](https://astro-semantius.vercel.app/) |
...
```bash
npx @gladtek/launch-semantius@latest
```
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/GladTek/Semantius.git
   cd Semantius
   ```
...
| `SITE_URL` | The production URL of the site. | `https://semantius.gladtek.com` |
