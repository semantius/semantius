...
**Generated:** 2026-09-18T17:09:10.747Z
...
| `event_time` (core) | date-time | Event Time | When the DDL command completed | string | false | - | 10 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `user_id` (core) | int32 | User Id | Internal user id from JWT context (0 when unavailable) | integer | false | - | 20 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `object_type` (core) | text | Object Type | Type of database object affected | string | false | - | 40 | readonly | default | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
...
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int64 | Id | - | integer | true | - | 1 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `record_id` (core) | uuid | Record Id | Deterministic UUID computed from table OID and primary key values | string | false | - | 10 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `old_record_id` (core) | uuid | Old Record Id | Record id before update/delete | string | false | - | 20 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `record_pk` (core) | text | Record PK | Primary key value of the affected record | string | false | - | 25 | readonly | default | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `ts` (core) | date-time | Timestamp | When the operation occurred | string | false | - | 40 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `user_id` (core) | int32 | User Id | Internal user id from JWT context (0 when unavailable) | integer | false | - | 50 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `db_role` (core) | text | DB Role | Role that authenticated the writing connection (session_user) | string | false | - | 52 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `is_superuser` (core) | boolean | Is Superuser | Whether the writing session had superuser privileges | boolean | false | - | 54 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `client_addr` (core) | text | Client Addr | Connecting client address; NULL for a unix-socket connection | string | false | - | 56 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `table_schema` (core) | text | Table Schema | Schema containing the table | string | false | - | 70 | readonly | default | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `table_name` (label) | text | Table Name | Name of the affected table | string | false | - | 80 | readonly | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `config` | json | Configuration | Dashboard layout and widget configuration | json | false | - | 10 | default | w | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `position` | int32 | Position | Display order position | integer | false | 0 | 20 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `label` (label) | text | Dashboard | Name that identifies this dashboard | string | false | - | 20 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `module_id` | reference | Module | Module this dashboard belongs to | integer | false | - | 30 | default | default | - | false | - | 2 | modules | cascade | has | - | - | false | auto | - | - |
| `view_permission` | reference | View Permission | Permission required to view this dashboard, by name | string | false | - | 40 | default | default | - | false | - | 2 | permissions | clear | has | - | - | false | auto | - | - |
...
| `singular_label` (label) | text | Singular Label | Human-readable singular label for UI/reports | string | false | - | 30 | default | default | label | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `plural_label` (core) | text | Plural Label | Human-readable plural label for UI/reports | string | false | - | 40 | default | default | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `icon_url` (core) | url | Icon URL | Optional URL or path to icon for this table | string | false | - | 50 | default | w | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `description` (core) | text | Description | What the entity represents | string | false | - | 60 | default | w | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `module_id` (core) | reference | Module Id | Module this entity belongs to | integer | false | - | 70 | required | default | core | false | - | 2 | modules | cascade | contains | - | - | false | auto | - | - |
| `view_permission` (core) | reference | View Permission | Permission required to SELECT from this table, by name | string | false | public:read | 80 | default | default | core | false | - | 2 | permissions | restrict | gates viewing | - | - | false | auto | - | - |
| `edit_permission` (core) | reference | Edit Permission | Permission required to INSERT/UPDATE/DELETE from this table, by name | string | false | admin | 90 | default | default | core | false | - | 2 | permissions | restrict | gates editing | - | - | false | auto | - | - |
...
| `label_parent` (core) | text | Label Parent | Reference or parent field of this entity whose record label the composed _label is built from (the identity spine). Empty = self-identifying: the composed label is the local label. Not allowed on a junction entity, and the spine must stay acyclic. | string | false | - | 111 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `order_column` (core) | text | Order Column | Name of an integer column that stores a fixed row order. Setting it creates the column, and a record inserted without a value gets MAX + 10. Empty = no fixed order. | string | false | - | 112 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `managed` (core) | boolean | Managed | When false, automatic DDL execution is disabled | boolean | false | true | 115 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `searchable` (core) | boolean | Searchable | Whether table is included in full-text search (auto-computed) | boolean | false | - | 117 | disabled | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `is_child` (core) | boolean | Is Child | Whether table has any parent relationships (auto-computed) | boolean | false | - | 118 | disabled | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `edit_mode` (core) | enum | Edit Mode | UI edit mode for records of this table: auto, sidebar, modal, or page | string | false | auto | 119 | default | default | core | false | ["auto","sidebar","modal","page"] | 2 | - | - | - | - | - | false | auto | - | - |
| `cube_mode` (core) | enum | Cube Mode | Cube mode for OLAP cube generation | string | false | auto | 121 | default | default | core | false | ["disabled","auto"] | 2 | - | - | - | - | - | false | auto | - | - |
| `audit_log` (core) | boolean | Audit Log | When TRUE, DML operations on this table are logged to audit_record_logs | boolean | false | false | 122 | default | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `select_rule` (core) | jsonlogic | Select Rule | JsonLogic rule evaluated per row for the FOR SELECT RLS policy: true = the current user may see the record. Empty = no per-row rule. | json | false | - | 125 | default | w | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `table_name` (core) | parent | Table Name | Entity this field belongs to | string | false | - | 20 | default | default | core | true | - | 2 | entities | cascade | has fields | - | - | false | auto | - | - |
...
| `title` (label) | text | Title | Human-readable display name for the field | string | false | - | 50 | required | default | label | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `description` (core) | text | Description | What the field represents | string | false | - | 60 | default | w | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `is_pk` (core) | boolean | Is Primary Key | Whether this field is the primary key; cannot change after the field is created | boolean | false | - | 70 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `field_order` (core) | int32 | Field Order | Display order of the field within its entity | integer | false | - | 100 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `width` (core) | enum | Width | Display width of the field in the UI | string | false | default | 120 | required | default | core | false | ["default","s","m","w"] | 2 | - | - | - | - | - | false | auto | - | - |
| `ctype` (core) | enum | Column Type | Marks a DD-managed core column: empty (normal user field), id (primary key), label (display field), audit (record-versioning columns such as created_at and updated_at) or core (other system columns). A core column cannot be deleted or renamed (the label column may be renamed), and its format and default value cannot change. Set by the DD only and never changed. | string | false | - | 130 | default | default | core | false | ["","id","label","audit","core"] | 2 | - | - | - | - | - | false | auto | - | - |
| `searchable` (core) | boolean | Searchable | Whether field is included in full-text search | boolean | false | - | 150 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"in":[{"var":"format"},["string","text","multiline","html","code"]]},"default","hidden"]} | - |
| `enum_values` (core) | json | Enum Values | JSON array of allowed enum values | json | false | - | 160 | hidden | w | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"==":[{"var":"format"},"enum"]},"required","hidden"]} | - |
| `precision` (core) | int32 | Precision | Decimal scale used when generating NUMERIC columns for number formats | integer | false | 2 | 170 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"==":[{"var":"format"},"number"]},"required","hidden"]} | - |
| `reference_table` (core) | text | Reference Table | Table name for foreign key relationships | string | false | - | 180 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"in":[{"var":"format"},["reference","parent"]]},"required","hidden"]} | - |
...
| `singular_label_parent` (core) | text | Singular Label Parent | Custom singular label for the parent entity (overrides default when set) | string | false | - | 210 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"==":[{"var":"format"},"parent"]},"default","hidden"]} | - |
| `plural_label_parent` (core) | text | Plural Label Parent | Custom plural label for the parent entity (overrides default when set) | string | false | - | 220 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"==":[{"var":"format"},"parent"]},"default","hidden"]} | - |
| `unique_value` (core) | boolean | Unique Value | When TRUE, enforces a partial unique index (NULL and empty strings are not enforced) | boolean | false | - | 230 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"in":[{"var":"format"},["boolean","multiline","html","code","json","jsonlogic","object","array"]]},"hidden","default"]} | - |
...
| `input_type_rule` (core) | jsonlogic | Input Type Rule | JsonLogic rule returning an input_type (default, required, readonly, disabled or hidden) that replaces the static input_type | json | false | - | 250 | default | w | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 1 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `module_name` (label) | text | Module Name | Unique module name | string | false | - | 10 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `description` (core) | text | Description | What the module covers | string | false | - | 20 | default | w | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `module_type` (core) | enum | Module Type | Module type: domain (normal) or master (promoted for sharing) | string | false | - | 25 | readonly | default | core | false | ["domain","master"] | 2 | - | - | has | - | - | false | auto | - | - |
| `view_permission` (core) | reference | View Permission | Permission required to view this module, by name | string | false | - | 30 | default | default | core | false | - | 2 | permissions | restrict | has | - | - | false | auto | - | - |
| `logo_color` (core) | text | Logo Color | Hex color code for module logo | string | false | - | 36 | default | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `icon_name` (core) | text | Icon Name | Icon or logo name identifier | string | false | - | 37 | default | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `home_page` (core) | text | Home Page | Default home page path for module | string | false | - | 38 | default | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `module_slug` (core) | text | Module Slug | URL-safe unique identifier for the module: lowercase, starting with a letter or digit, using only a-z, 0-9, - and _. | string | false | - | 38 | required | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `manage_permission` (core) | reference | Manage Permission | Manage permission of this module, by name | string | false | - | 39 | default | default | core | false | - | 2 | permissions | clear | has | - | - | false | auto | - | - |
| `admin_permission` (core) | reference | Admin Permission | Admin permission of this module, by name | string | false | - | 40 | default | default | core | false | - | 2 | permissions | clear | has | - | - | false | auto | - | - |
| `default_viewer_role_id` (core) | reference | Default Viewer Role | Default viewer role of this module | integer | false | - | 41 | default | default | core | false | - | 2 | roles | clear | has | - | - | false | auto | - | - |
| `default_manager_role_id` (core) | reference | Default Manager Role | Default manager role of this module | integer | false | - | 42 | default | default | core | false | - | 2 | roles | clear | has | - | - | false | auto | - | - |
| `default_admin_role_id` (core) | reference | Default Admin Role | Default admin role of this module | integer | false | - | 43 | default | default | core | false | - | 2 | roles | clear | has | - | - | false | auto | - | - |
| `catalog_module_code` (core) | text | Catalog Module Code | Catalog blueprint this module was provisioned/cloned from; also the domain axis (non-unique). Write-once: set on create or filled once while empty, then never changed. Empty = not generated from a catalog spec. | string | false | - | 44 | default | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `access_scope` (core) | enum | Access Scope | Basic for simple read/edit; full for role tiers, approvals & gating | string | false | - | 46 | default | default | core | false | ["basic","full"] | 2 | - | - | has | - | - | false | auto | - | - |
| `settings` (core) | json | Settings | Module-specific settings and configuration | json | false | - | 50 | default | w | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `version_date` (core) | date-time | Version Date | Timestamp of last version change | string | false | - | 86 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `including_permission_name` (core) | parent | Including Permission Name | The broader permission, by name: holding it implies the included permission (e.g. crm:manage includes crm:read). | string | false | - | 10 | default | default | core | false | - | 2 | permissions | cascade | includes | Includes | Includes | false | auto | - | - |
| `included_permission_name` (core) | parent | Included Permission Name | The narrower permission that is included by the broader one, by name | string | false | - | 20 | default | default | core | false | - | 2 | permissions | cascade | included in | Included in | Included in | false | auto | - | - |
| `origin` (core) | enum | Origin | How the hierarchy entry was created: system (platform built-in), model (declared in the model of a domain module), model_master (created by the deployer for a master module, inside it or between it and other modules) or user (added by an admin). Set on insert and never changed. | string | false | - | 25 | readonly | default | core | false | ["system","model","model_master","user"] | 2 | - | - | - | - | - | false | auto | - | - |
...
| `description` (core) | multiline | Description | What the permission allows | string | false | - | 20 | default | w | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `module_id` (core) | reference | Module Id | Module this permission belongs to | integer | false | - | 30 | required | default | core | false | - | 2 | modules | cascade | contains | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `name` (label) | text | Name | Display name of the process | string | false | - | 10 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `description` | multiline | Description | Detailed description of the process | string | false | - | 40 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `ordering` | integer | Ordering | Optional display ordering | integer | false | - | 50 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `process_id` | parent | Process | The governed process | integer | false | - | 10 | required | default | - | false | - | 2 | processes | cascade | has | - | - | false | auto | - | - |
| `entity` | text | Entity | Governed table name (mirrors entities.table_name) | string | false | - | 20 | required | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `gate_kind` | enum | Gate Kind | Type of governance gate | string | false | - | 30 | required | default | - | false | ["approval","submit_lock","ownership","create","transition"] | 2 | - | - | has | - | - | false | auto | - | - |
...
| `emits_events` | boolean | Emits Events | When TRUE, entering to_state inserts raci_events | boolean | false | - | 60 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `queue_name` (label) | text | Queue | Name that identifies this queue | string | false | - | 20 | required | default | label | true | - | 2 | - | - | has | - | - | true | auto | - | - |
| `view_permission` | reference | View Permission | Permission required to read messages from this queue (queue_read), by name. Readers see the table, id and operation of every table mapped to this queue. | string | false | admin | 30 | default | default | - | false | - | 2 | permissions | restrict | gates reading | - | - | false | auto | - | - |
| `manage_permission` | reference | Manage Permission | Permission required to pop, archive or delete messages from this queue, by name. | string | false | admin | 40 | default | default | - | false | - | 2 | permissions | restrict | gates managing | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `queue_id` | parent | Queue | Parent queue this event belongs to | integer | false | - | 5 | default | default | - | false | - | 2 | queues | cascade | has events | - | - | false | auto | - | - |
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `table_name` | reference | Table | Table whose DML events are captured | string | false | - | 10 | required | default | - | false | - | 2 | entities | cascade | has queue events | - | - | true | auto | - | - |
...
| `event_name` (label) | text | Queue Table Event | Name that identifies this queue table event | string | false | - | 20 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `raci` | enum | RACI | Responsibility letter | string | false | - | 30 | required | default | - | false | ["responsible","accountable","consulted","informed"] | 2 | - | - | has | - | - | false | auto | - | - |
| `consult_mode` | enum | Consult Mode | Consultation mode (only for raci=consulted) | string | false | read | 40 | default | default | - | false | ["read","notify","block"] | 2 | - | - | has | - | - | false | auto | - | - |
| `origin` | enum | Origin | How this row was created | string | false | user | 50 | default | default | - | false | ["system","user"] | 2 | - | - | has | - | - | false | auto | - | - |
...
| `process_id` | parent | Process | The governed process | integer | false | - | 10 | required | default | - | false | - | 2 | processes | cascade | has | - | - | false | auto | - | - |
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `entity` | text | Entity | Governed table name | string | false | - | 20 | required | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `record_id` (label) | text | Record Id | Governed record PK (text for non-integer PKs) | string | false | - | 30 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `raci` | enum | RACI | consulted or informed | string | false | - | 40 | required | default | - | false | ["consulted","informed"] | 2 | - | - | has | - | - | false | auto | - | - |
...
| `status` | enum | Status | pending → sent → acted | string | false | pending | 60 | required | default | - | false | ["pending","sent","acted"] | 2 | - | - | has | - | - | false | auto | - | - |
...
| `role_id` (core) | parent | Role Id | Role this permission is granted to | integer | false | - | 10 | default | default | core | false | - | 2 | roles | cascade | has permissions | Permission | Permissions | false | auto | - | - |
| `permission_name` (core) | parent | Permission Name | Permission granted to the role, by name | string | false | - | 20 | default | default | core | false | - | 2 | permissions | cascade | granted to | Permission | Permissions | false | auto | - | - |
| `granted_at` (core) | date-time | Granted At | Timestamp when permission was granted | string | false | - | 30 | disabled | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `granted_by` (core) | reference | Granted By | User who granted this permission | integer | false | - | 40 | default | default | core | false | - | 2 | users | clear | has granted | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 1 | readonly | default | id | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `role_name` (label) | text | Role Name | Unique role name | string | false | - | 10 | required | default | label | true | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `description` (core) | multiline | Description | What the role is for | string | false | - | 20 | default | w | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
| `origin` (core) | enum | Origin | How the role was created: system (platform built-in), model (scaffold role of a domain module), model_master (scaffold role of a master module) or user (created by an admin). Set on insert and never changed. | string | false | - | 25 | readonly | default | core | false | ["system","model","model_master","user"] | 2 | - | - | - | - | - | false | auto | - | - |
| `module_id` (core) | reference | Module Id | Module this role belongs to | integer | false | - | 30 | default | default | core | false | - | 2 | modules | clear | contains | - | - | false | auto | - | - |
...
| `title` (label) | text | User Bookmark | Name that identifies this user bookmark | string | false | - | 20 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `url` | text | URL | Bookmark URL | string | false | - | 30 | default | w | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `entity_name` | text | Entity | Name of the related entity table | string | false | - | 40 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `entity_id` | int32 | Entity ID | ID of the related record in the entity table (0 = no record) | integer | false | - | 50 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `user_id` (core) | parent | User Id | User this permission is granted to | integer | false | - | 10 | required | default | core | false | - | 2 | users | cascade | has permissions | Permission | Permissions | false | auto | - | - |
| `permission_name` (core) | parent | Permission Name | Permission granted to the user, by name | string | false | - | 20 | required | default | core | false | - | 2 | permissions | cascade | granted to | User | Users | false | auto | - | - |
| `granted_at` (core) | date-time | Granted At | Timestamp when permission was granted | string | false | - | 30 | disabled | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `granted_by` (core) | reference | Granted By | User who granted this permission | integer | false | - | 40 | default | default | core | false | - | 2 | users | clear | has granted | - | - | false | auto | - | - |
...
| `user_id` (core) | parent | User Id | User this role is assigned to | integer | false | - | 10 | required | default | core | false | - | 2 | users | cascade | has roles | Role | Roles | false | auto | - | - |
| `role_id` (core) | parent | Role Id | Role assigned to the user | integer | false | - | 20 | required | default | core | false | - | 2 | roles | cascade | assigned to | User | Users | false | auto | - | - |
| `assigned_at` (core) | date-time | Assigned At | Timestamp when role was assigned | string | false | - | 30 | disabled | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `assigned_by` (core) | reference | Assigned By | User who assigned this role | integer | false | - | 40 | default | default | core | false | - | 2 | users | clear | has assigned | - | - | false | auto | - | - |
...
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 1 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `external_id` (core) | text | External Id | Identity: the JWT sub claim from the authentication provider. Never empty: a human user must bring one, and an agent saved without one gets agent:<uuid>. | string | false | - | 10 | readonly | default | core | true | - | 2 | - | - | has | - | - | true | auto | - | - |
| `email` (label) | email | Email | Email address of the user | string | false | - | 20 | default | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `first_name` (core) | text | First Name | First name from JWT given_name claim | string | false | - | 22 | default | default | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `last_name` (core) | text | Last Name | Last name from JWT family_name claim | string | false | - | 23 | default | default | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `display_name` (core) | text | Display Name | Display name from the JWT name claim | string | false | - | 25 | default | default | core | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `is_disabled` (core) | boolean | Is Disabled | When TRUE, the user account is disabled | boolean | false | - | 30 | default | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `settings` (core) | json | Settings | User-specific settings and preferences | json | false | - | 35 | default | w | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `last_seen` (core) | date-time | Last Seen | Timestamp when user was last active | string | false | - | 60 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `is_agent` | boolean | Is Agent | When TRUE this user is a service principal (agent) | boolean | false | false | 100 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `webhook_receiver_id` | parent | Webhook Receiver | Parent webhook receiver this log belongs to | integer | false | - | 5 | default | default | - | false | - | 2 | webhook_receivers | cascade | has logs | - | - | false | auto | - | - |
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `message_id` | text | Message Id | The sender's webhook-id header, or a key derived from the request when it sends none. A delivery whose message_id already succeeded is skipped. | string | false | - | 10 | default | default | - | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `label` (label) | text | Webhook Receiver Log | Name that identifies this webhook receiver log | string | false | - | 20 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `received_timestamp` | date-time | Received Timestamp | Timestamp when webhook was received | string | false | CURRENT_TIMESTAMP | 40 | disabled | default | - | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `payload` | json | Payload | Webhook payload data | json | false | - | 50 | default | w | - | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `error_message` | text | Error Message | Error message if processing failed | string | false | - | 70 | default | w | - | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `table_name` | reference | Table | Target table for webhook data | string | false | - | 10 | default | default | - | false | - | 2 | entities | cascade | has receivers | - | - | false | auto | - | - |
| `description` | text | Description | Description of webhook receiver purpose | string | false | - | 20 | default | w | - | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `label` (label) | text | Webhook Receiver | Name that identifies this webhook receiver | string | false | - | 20 | required | default | label | true | - | 2 | - | - | has | - | - | false | auto | - | - |
| `auth_type` | enum | Authentication Type | Type of authentication (none, hmac, or custom header) | string | false | none | 30 | default | default | - | false | ["none","hmac","header"] | 2 | - | - | - | - | - | false | auto | - | - |
| `secret` | text | Secret | Secret for webhook authentication | string | false | - | 40 | default | default | - | false | - | 2 | - | - | - | - | - | false | auto | - | - |
