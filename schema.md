...
| `user_id` (core) | int32 | User Id | Internal user id from JWT context (0 when unavailable, e.g. during migrations) | integer | false | - | 20 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| `is_superuser` (core) | boolean | Is Superuser | Whether the writing session had superuser privileges. TRUE on a data row means RLS was bypassed. Reports the session, not the owner of a SECURITY DEFINER function. | boolean | false | - | 54 | readonly | default | core | false | - | 2 | - | - | has | - | - | false | auto | - | - |
...
| field_name | format | title | description | type | is_pk | default_value | field_order | input_type | width | ctype | searchable | enum_values | precision | reference_table | reference_delete_mode | relationship_label | singular_label_parent | plural_label_parent | unique_value | cube_type | input_type_rule | catalog_field_code |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|
| `table_name` 🔑 (id) | text | Table Name | Physical table name in database: lowercase letters, digits and _, starting with a letter or _ | string | true | - | 1 | required | default | id | true | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `id_column` (core) | text | Id Column | Name of the primary key column, created automatically | string | false | id | 100 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `label_column` (core) | text | Label Column | Name of the label/display column, created automatically | string | false | label | 110 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `managed` (core) | boolean | Managed | When false, automatic DDL execution for table and field changes is disabled | boolean | false | true | 115 | default | default | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `computed_fields` (core) | jsonlogic | Computed Fields | Ordered list of {name, jsonlogic, description?} entries, evaluated and stored on every insert and update: each entry derives the named field from the same record before the write | json | false | - | 123 | default | w | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
| `validation_rules` (core) | jsonlogic | Validation Rules | Ordered list of {code, message, jsonlogic, description?} entries; each must evaluate truthy for the write to succeed | json | false | - | 124 | default | w | core | false | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `field_name` (core) | text | Field Name | Physical column name in database: lowercase letters, digits and _. Names starting with _ are reserved for generated system columns such as _label. | string | false | - | 30 | required | default | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `description` (core) | text | Description | What the field represents. Also written into the column comment, which PostgREST shows in its OpenAPI output. | string | false | - | 60 | default | w | core | true | - | 2 | - | - | - | - | - | false | auto | - | - |
...
| `width` (core) | enum | Width | Display width of the field in the UI: default (automatic), s (small), m (medium) or w (wide) | string | false | default | 120 | required | default | core | false | ["default","s","m","w"] | 2 | - | - | - | - | - | false | auto | - | - |
...
| `unique_value` (core) | boolean | Unique Value | When TRUE, enforces a partial unique index on this column. For string types, NULL and empty string values are excluded from the uniqueness check. | boolean | false | - | 230 | hidden | default | core | false | - | 2 | - | - | - | - | - | false | auto | {"if":[{"in":[{"var":"format"},["boolean","multiline","html","code","json","jsonlogic","object","array"]]},"hidden","default"]} | - |
...
| `access_scope` (core) | enum | Access Scope | Access tier: basic (simple read/edit) or full (role tiers, approvals and gating) | string | false | - | 46 | default | default | core | false | ["basic","full"] | 2 | - | - | has | - | - | false | auto | - | - |
...
| `id` 🔑 (id) | int32 | Id | Internal identifier, assigned automatically | integer | true | - | 10 | readonly | default | id | false | - | 2 | - | - | has | - | - | false | auto | - | - |
| `module_id` | reference | Module | Owning module. NULL = cross-module or unowned process | integer | false | - | 20 | default | default | - | false | - | 2 | modules | clear | has | - | - | false | auto | - | - |
...
| `emits_events` | boolean | Emits Events | When TRUE, entering to_state inserts raci_events for the consulted and informed actors | boolean | false | - | 60 | default | default | - | false | - | 2 | - | - | has | - | - | false | auto | - | - |
